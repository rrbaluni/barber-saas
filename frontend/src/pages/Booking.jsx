  ...
  if (submitted) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mb-6">We'll see you soon. A confirmation has been sent to {form.email}.</p>
        <button onClick={() => navigate('/')} className="bg-gray-900 text-white px-6 py-2 rounded-full font-semibold hover:bg-gray-800 transition">
          Back Home
        </button>
      </div>
    );
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {dates.map(d => {
                ...
                const active = f === selectedDate;
                return (
                  <button
                    key={f}
                    onClick={() => { setSelectedDate(f); setSelectedTime(''); }}
                    className={`flex-shrink-0 px-4 py-3 rounded-xl text-center border-2 transition ${
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <input
                ...
                className="border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-400"
              />
              <input
                required
                type="email"
